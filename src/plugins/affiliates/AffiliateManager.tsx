...
function LivePreview({
  ...
  return (
    <div className="rounded-xl border border-adm-border overflow-hidden bg-white shadow-sm">
      ...
      <div className="flex gap-3 p-3">
        {form.image && (
          <div className="w-16 h-16 shrink-0 rounded-lg bg-adm-bg border border-adm-border overflow-hidden">
            <img
              src={form.image}
              alt=""
...
const inputClass =
  'w-full bg-white border border-adm-border rounded-xl px-4 py-3 text-sm font-medium text-adm-ink focus:outline-none focus:border-violet-500 focus:ring-2 focus:ring-adm-primary/25 transition-all shadow-sm';
...
export default function AffiliateManager() {
  ...
  return (
    <div className="max-w-4xl space-y-5">
        ...
        <div className="flex gap-1 bg-slate-100 p-1 rounded-xl">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-bold transition-all ${
              tab === 'products' ? 'bg-white text-adm-ink shadow-sm' : 'text-adm-ink-muted hover:text-slate-700'
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-bold transition-all ${
              tab === 'settings' ? 'bg-white text-adm-ink shadow-sm' : 'text-adm-ink-muted hover:text-slate-700'
            }`}
          >
      ...
      {tab === 'products' && (
        <>
            ...
            <div className="bg-white rounded-2xl border border-adm-border shadow-sm">
              ...
              <div className="px-6 py-4 border-b border-adm-border flex items-center justify-between bg-gradient-to-r from-slate-50 to-amber-50/40 rounded-t-2xl">
                ...
                <button
                  ...
                  className="text-xs text-adm-ink-faint hover:text-adm-ink-muted bg-slate-100 hover:bg-slate-200 px-3 py-1.5 rounded-lg font-medium transition-colors"
                >
                  Cancelar
                </button>
              </div>
              ...
              <div className="grid lg:grid-cols-[1fr_300px] divide-y lg:divide-y-0 lg:divide-x divide-slate-100">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex gap-2 p-3 bg-amber-50 border border-amber-200 rounded-xl">
                    <div className="flex-1">
                      <input
                        ...
                        className="w-full bg-white border border-amber-200 rounded-lg px-3 py-2 text-sm font-mono text-adm-ink focus:outline-none focus:border-amber-400 focus:ring-2 focus:ring-amber-400/20 transition-all"
                  ...
                  <div className="grid grid-cols-[1fr_auto] gap-3 items-end">
                    ...
                    {form.image && (
                      <img
                        src={form.image}
                        alt="preview"
                        className="w-14 h-14 object-contain rounded-xl border border-adm-border bg-adm-bg shadow-sm"
                    ...
                    {extraLinks.length === 0 ? (
                      ...
                      <div className="space-y-3">
                        {extraLinks.map((link, i) => (
                          <div key={i} className="bg-white border border-adm-border rounded-lg p-3">
                  ...
                  <label className="flex items-center gap-3 cursor-pointer p-3 bg-adm-bg rounded-xl hover:bg-amber-50 transition-colors w-fit">
                    <input
                      type="checkbox"
          ...
          {!showForm && products.length === 0 && (
            <div className="bg-white rounded-2xl border border-dashed border-adm-border p-16 text-center">
              ...
              <p className="text-adm-ink-faint text-sm mb-6 max-w-xs mx-auto leading-relaxed">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-4 p-4">
                      {/* Image */}
                      <div className="w-16 h-16 rounded-xl border border-adm-border bg-adm-bg flex items-center justify-center overflow-hidden shrink-0">
                        {p.image ? (
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 flex-wrap mb-0.5">
                          ...
                          {!p.enabled && (
                            <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-slate-100 text-adm-ink-faint">
                              Inativo
                            </span>
                          )}
                        </div>
                      ...
                      <div className="flex items-center gap-0.5 shrink-0">
                        <button
                          ...
                          title="Editar"
                          className="p-2 text-slate-300 hover:text-adm-primary hover:bg-adm-primary-soft rounded-xl transition-colors"
                        >
      ...
      {/* ── SETTINGS TAB ── */}
      {tab === 'settings' && (
        <div className="bg-white rounded-2xl border border-adm-border shadow-sm p-6 space-y-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <input
                ...
                className="w-12 h-12 rounded-xl border border-adm-border cursor-pointer p-1 shadow-sm"
              />
              <input
                type="text"
                value={config.buttonColor}
          ...
          {/* PA-API credentials */}
          <div className="border border-adm-border rounded-2xl p-5 space-y-4">
            <div className="flex items-center gap-2 mb-1">
              <KeyRound className="w-4 h-4 text-amber-500" />
              <p className="text-sm font-bold text-slate-700">Credenciais PA-API 5.0</p>
              <span className="ml-auto text-xs text-adm-ink-faint">Necessário para "Importar da Amazon"</span>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
            ...
            <p className="text-xs text-adm-ink-faint mt-1 ml-0.5">
          ...
          <div className="border-t border-adm-border pt-5">
            ...
            <div className="grid grid-cols-2 gap-2">
              {([
                ...
                <label
                  key={key}
                  className="flex items-center gap-3 cursor-pointer p-3 bg-adm-bg rounded-xl hover:bg-amber-50 transition-colors"
                >
                  <input
                    type="checkbox"
                    checked={!!config[key]}
