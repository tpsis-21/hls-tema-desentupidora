...
export default function DeployManager() {
    ...
    if (ui === 'not_configured') {
        return (
            <div className="bg-adm-bg border border-adm-border rounded-xl px-4 py-3 mb-6 flex items-center gap-3">
    ...
    if (ui === 'snoozed') {
        ...
        return (
            <div className="bg-adm-bg border border-adm-border rounded-xl px-4 py-2.5 mb-6 flex items-center justify-between gap-4">
